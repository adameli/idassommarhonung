...
export default function Hexagon({ children, color = "#f9dc5c", strokeColor = "#eeba0b" }) {
    return (
        <div className="relative min-w-40 w-full h-60 flex items-center justify-center text-white font-semibold text-center">
            ...
            <div className="relative z-10 px-6 text-gray-900">{children}</div>
        </div>
    );
}
